...
pub enum NativeException {
    ...
    SupervisorReservedRead(u16),
    SupervisorReservedWrite(u16),
    SupervisorReservedExec(u16),
    SupervisorReservedInstruction,
    DivisionOrModByZero,
...
impl NativeException {
    ...
    pub fn decode_with_mode(ex: u32) -> Result<(Self, bool), ()> {
        ...
        let ex = match code {
            ...
            0x06 => Self::SupervisorReservedRead(data),
            0x07 => Self::SupervisorReservedWrite(data),
            0x08 => Self::SupervisorReservedExec(data),
            0x09 => Self::SupervisorReservedInstruction,
    ...
    pub fn code(&self) -> u8 {
        match self {
            ...
            Self::SupervisorReservedRead(_) => 0x06,
            Self::SupervisorReservedWrite(_) => 0x07,
            Self::SupervisorReservedExec(_) => 0x08,
            Self::SupervisorReservedInstruction => 0x09,
    ...
    pub fn associated_data(&self) -> Option<u16> {
        match self {
            ...
            Self::SupervisorReservedRead(addr_lower) => Some(*addr_lower),
            Self::SupervisorReservedWrite(addr_lower) => Some(*addr_lower),
            Self::SupervisorReservedExec(addr_lower) => Some(*addr_lower),
            Self::SupervisorReservedInstruction => None,
