...
pub struct DeviceMetadata {
    ...
    pub dev_model: Option<u32>,
    pub additional_data: Option<u64>
}

impl DeviceMetadata {
    pub fn new(hw_id: u64, dev_size: u32, dev_category: DeviceCategory, dev_model: Option<u32>, additional_data: Option<u64>) -> Self {
    ...
    pub fn to_bytes(&self) -> [u8; 32] {
        ...
        bytes[ 8..=11].copy_from_slice(&self.dev_size.to_be_bytes());
        bytes[12..=19].copy_from_slice(&self.dev_category.encode().to_be_bytes());
        bytes[20..=23].copy_from_slice(&self.dev_model.unwrap_or(0).to_be_bytes());
